...
IMAGE_PROMPT = """Du bist ein Poker-Kartenscanner. Erkenne alle Karten und gib nur JSON zurück.

FARBEN — ZWEIMAL PRÜFEN:
...
POSITIONEN:
• HOLE CARDS: 2 Karten GANZ VORNE UNTEN im Bild (nah zur Kamera) — egal ob Handy quer oder hochkant
• BOARD: Karten in Tischmitte, STRIKT von LINKS nach RECHTS
• Flop=3 Karten, Turn=4, River=5 — mittlere Karte nicht vergessen!
• Kleine umgedrehte Zahl unten rechts auf Karte = IGNORIEREN
