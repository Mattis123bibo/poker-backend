...
WICHTIG: Analysiere NUR was du auf DIESEM Bild siehst — ignoriere jeden vorherigen Kontext!
Wenn keine Karten sichtbar sind → myHand = "Nicht erkennbar", board = "", opponents = 1
Erfinde NIEMALS Karten die nicht auf dem aktuellen Bild zu sehen sind!
